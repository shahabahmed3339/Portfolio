...
export default function HeroSection({ onContactClick, onDownloadClick, isDownloading }: HeroSectionProps) {
    return (
        <main className="flex flex-col items-center pt-20 max-md:px-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between md:items-start w-full max-w-4xl mx-auto">
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-2xl md:text-3xl font-mono mt-4">
                        Software Engineer
                    </p>

                    <div className="mt-1 text-xs flex flex-row items-center hover:-translate-y-0.5 transition">
                        ...
                        <a href="https://github.com/shahabahmed3339" target="_blank" className="hover:underline ml-1">
                            +92 315 1586289
                        </a>
                        &nbsp;&nbsp;
                        <a href="https://github.com/shahabahmed3339" target="_blank" className="hover:underline ml-1">
            ...
            {/* Links */}
            <div className="mt-2 text-xs flex flex-col md:flex-row items-center justify-between md:items-start w-full max-w-4xl mx-auto">
